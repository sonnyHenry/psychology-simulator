...
export const year2Events: GameEvent[] = [
  // ── 大二的高光:第一次读懂结果部分 ───────────────────────
  {
    ...
    order: 20,
    title: '你第一次看懂了结果部分',
    text: '一个普通的下午，你在图书馆读一篇英文文献。读到 Results（结果）那一节，你本来准备像往常一样跳过去。\n\n然后你发现你没跳。\n\n“F(2, 87) = 6.34, p = .003, η² = .13”——你知道这行字在说什么了。你知道 87 意味着他们大概招了 90 个人，知道 η² = .13 代表差异不小，也知道作者为什么要用 Bonferroni 方法降低“比较次数太多而碰巧显著”的风险。\n\n你把那一页翻回去又读了一遍，不是因为没读懂，是因为读懂了。',
    contextLines: [
    ...
    choices: [
      {
        ...
        outcomes: [
          {
            weight: 1,
            text: '你把开放研究平台 OSF 的网址抄在笔记本第一页。\n\n后来你有一半的课题在收数据前登记了方案，另一半没有。原因每次都很具体，而且每次都说得通。',
  ...
  },
  {
    ...
    weight: 5,
    title: '你算了一遍那篇文章的效应量',
    text: '你在图书馆里把那篇后来没能被重复出来的经典文章翻出来，自己算了一遍。\n\n42 个参与者。统计结果刚刚跨过常用门槛：p = .045。\n\n你又算了算，要有八成把握发现这种大小的真实差异，需要多少人。数字出来时你在纸上圈了三遍：**将近 200 个**。\n\n这篇文章上过教材。',
    contextLines: [
      ...
      },
      {
        ...
        text: '“有多大把握发现真实差异”的那个公式是你自己推的——大一被高数虐过的人，在这里突然占了一次便宜。',
      },
